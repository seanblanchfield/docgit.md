...
- [ ] Create WIP file
- [ ] Add `#content-wrapper` div in HTML
- [ ] Rename `#editor-status-bar` to `#editor-toolbar`
- [ ] Move `.mode-control` to be sibling of other toolbar sections
- [ ] Update CSS: remove fixed positioning from `.mode-control`
- [ ] Add `position: sticky` to `#editor-toolbar`
- [ ] Update `#content` to be child of `#content-wrapper`
- [ ] Remove `overflow: auto` from old parent, add to new `#content`
- [ ] Test toolbar sticks correctly when scrolling
- [ ] Test with and without navbar injection
- [ ] Update any JavaScript that references changed elements
- [ ] Commit changes
